...
describe("Vote", () => {
  ...
  describe("#create()", () => {
    ...
    it("should not create a vote with invalid values", done => {
      Vote.create({
        value: 2,
        userId: this.user.id,
        postId: this.post.id
  ...
  describe("#getPoints", () => {
    it("should return the sum of all votes as integer", done => {
      Vote.create({
        value: 1,
        userId: this.user.id,
        postId: this.post.id
  ...
  describe("#hasUpvoteFor()", () => {
    it("should return true if userId has upvote for the post", (done) => {
      Vote.create({
        value: 1,
        postId: this.post.id,
        userId: this.user.id
  ...
  describe("#hasDownvoteFor()", () => {
    it("should return true if userId has downvote for the post", (done) => {
      Vote.create({
        value: -1,
        postId: this.post.id,
        userId: this.user.id
